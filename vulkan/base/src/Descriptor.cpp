...
Descriptor::Descriptor(KYPtr<LogicalDevice> logicalDevice, KYPtr<SwapChain> swapChain, KYPtr<ImageView> imageView, KYPtr<Sampler> sampler)
: m_LogicalDevice(logicalDevice), m_SwapChain(swapChain), m_ImageView(imageView), m_Sampler(sampler)
{
...
void Descriptor::createDescriptorSets() {
    ...
    auto swapChainImages = m_SwapChain->GetSwapChainImages();
    auto device = m_LogicalDevice->GetDevice();
    auto uniformBuffers = m_ImageView->GetBuffer()->GetUniformBuffers();
    auto textureImageView = m_ImageView->GetTextureImageView();
    auto textureSampler = m_Sampler->GetTextureSampler();
